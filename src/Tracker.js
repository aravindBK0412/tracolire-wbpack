...
class CalorieTracker{
    ...
    removeMeal(mealId){
        const index=this._meals.findIndex((meal)=>meal.id===mealId);
    ...
    removeWorkout(workoutId){
        const index=this._workouts.findIndex((workout)=>workout.id===workoutId);
    ...
    _displayCaloriesLimit(){
        const CalorieLimitsEl=document.getElementById('calories-limit');
        CalorieLimitsEl.innerHTML=this._calorieLimit;
